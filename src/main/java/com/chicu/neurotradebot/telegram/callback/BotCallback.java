...
public enum BotCallback {
    ...
    // Новые колбеки для конфигурации стратегий
    STRATEGY_CONFIG("strategy_config"), // Настройка параметров выбранной стратегии
    RESET_CONFIG("reset_config"), // Сброс конфигурации выбранной стратегии
